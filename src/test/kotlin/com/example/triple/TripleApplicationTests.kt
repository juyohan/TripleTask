...
class TripleApplicationTests(
    ...
    fun `초기 데이터`() {
        ...
        val eventDto1 = EventDto.Request.EventDetails(
            type = ActionType.REVIEW,
            action = ReviewActionType.ADD,
            reviewId = "1",
            content = "좋아요!",
        ...
        val eventDto2 = EventDto.Request.EventDetails(
            type = ActionType.REVIEW,
            action = ReviewActionType.ADD,
            reviewId = "2",
            content = "좋아요!",
            attachedPhotoIds = listOf("e4d1a64e-a531-46de-88d0-ff0ed70c0bb8"),
            userId = "2",
            placeId = "1"
        )
        val eventDto3 = EventDto.Request.EventDetails(
            type = ActionType.REVIEW,
            action = ReviewActionType.ADD,
            reviewId = "1",
            content = "좋아요!",
